...
function NavigationBar() {
  ...
  let totalCount = useSelector((state) => state.basket.totalCount);
  const MIN_TOTAL_BASKET = 1;

  if (totalCount < MIN_TOTAL_BASKET) {
    totalCount = MIN_TOTAL_BASKET;
  }

  return (
    <ul className="navigation-bar">
      <li className="navigation-bar__item">
        <a className="navigation-bar__link" href="/maps">
      ...
      <li className="navigation-bar__item navigation-bar__item--search">
        <a className="navigation-bar__link" href="/search">
      ...
      <li className="navigation-bar__item">
        <Link className="navigation-bar__link" to="/basket">
        ...
        <span className={baskets.length >= MIN_TOTAL_BASKET ? `navigation-bar__item-basket-increment navigation-bar__item-basket-increment--active` : `navigation-bar__item-basket-increment`}>{totalCount}</span>
      </li>
    </ul>
